...
# import mlflow
# import dagshub
# dagshub.init(repo_owner='Priyanshu-Ku', repo_name='network-security', mlflow=True)
...
class ModelTrainer:
    ...
    ## Stopped it will use when it is not in production level   
    # def track_mlflow(self,best_model_name:str,classification_train_metric:ClassificationMetricArtifact):
    #     with mlflow.start_run():
    #         # Move init here — only called during actual training
    #         import dagshub 
    #         dagshub.init(
    #             repo_owner='Priyanshu-Ku',
    ...
    def train_model(self,X_train,y_train,X_test,y_test):
        ...
        ## Track the mlflow 
        ## For train metric we are tracking the best model name and classification train metric
        # self.track_mlflow(best_model_name=best_model,classification_train_metric=classification_train_metric)
        
        
        y_test_pred = best_model.predict(X_test)
        classification_test_metric = get_classification_score(y_true=y_test,y_pred=y_test_pred)
        
        ## For test metric we are tracking the best model name and classification test metric
        # self.track_mlflow(best_model_name=best_model,classification_train_metric=classification_test_metric)
