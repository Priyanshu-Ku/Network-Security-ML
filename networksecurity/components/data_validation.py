...
class DataValidation:
    ...
    def validate_numerical_columns_exist(self,dataframe:pd.DataFrame) -> bool:
        try:
            ...
            logging.info(f"Required numerical columns for: {numerical_columns}")
            dataframe_numerical_columns = [feature for feature in dataframe.columns if dataframe[feature].dtype != 'O']
            logging.info(f"Dataframe has numerical columns: {dataframe_numerical_columns}")
            if len(dataframe_numerical_columns) == len(numerical_columns):
                return True
            return False
    ...
    def detect_dataset_drift(self,base_df,current_df,threshold=0.05) -> bool:
        try:
            ...
            return status ## Otherwise validation_status becomes None.
